  ...
  <div class="cs-hero cs-style1 cs-type1 text-center" id="home">
    ...
    <div class="container">
      <div class="cs-hero_text">
        <h2 class="cs-hero_title wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
          <span class="dual-tone">W</span>e Redefine <span class="dual-tone-1">M</span>obility
        </h1>
        <div class="cs-hero_info justify-content-center">
          <div class="cs-hero_subtitle">We redefine the future. We Think and work on required impossible aspects of riding DNA. We intend to deliver the world class best performance Economically sustainable vehicles To eminence driving experience.</div>
        </div>
      </div>
    </div>
    <a href="#about" class="cs-down_btn"></a>
  </div>
  <!-- End Hero -->
  <!-- About Us-->
      ...
      <div class="row">
        <div class="col-xl-5 col-lg-7">
          <div class="cs-section_heading cs-style1">
            <h2 class="cs-section_title">About Us</h2>
            <div class="cs-height_30 cs-height_lg_20"></div>
            <p class="cs-m0"> What if a passionate youngsters combining their dream of evolutionizing, passion of design & responsibility of sustainable future into their way of living...? We are the tomorrows' pioneer in economic & agent of decarbonized society. We focus on Aesthetics. Idea - concepts - reality. Infact we driven by the treaty of visualization.</p>
        ...
        <div class="col-lg-5 offset-xl-2">
          <img src="assets/img/auto.gif" alt="" class="w-100 cs-radius_15">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-xl-5 col-lg-6">
          <img src="assets/img/about_1.jpg" alt="Member" class="cs-radius_15 w-100">
        </div>
        <div class="col-lg-6 offset-xl-1">
          <div class="cs-height_0 cs-height_lg_45"></div>
            <div class="cs-height_45 cs-height_lg_25"></div>
            <p class="cs-m0">An Adaption of eco-Friendly futuristic & best performance electric vehicle transition to the world. We always project our telescope in revolutionizing the Eco-Futuristic society to value our customers we acquire.</p>
            <div class="cs-height_25 cs-height_lg_20"></div>
            <p class="cs-m0">We Adapt - Adopt - Evolve</p>
          ...
          <ul class="cs-post_3_list cs-mp0">
            <li>
              <div class="cs-post cs-style3">
                ...
                <div class="cs-post_right">
                  <h2 class="cs-post_title"><a href="#">How to keep fear from ruining your art business with confident</a></h2>
            ...
            <li>
              <div class="cs-post cs-style3">
                ...
                <div class="cs-post_right">
                  <h2 class="cs-post_title"><a href="#">A.I becomes more powerful day by day with new approaches</a></h2>
                  <div class="cs-post_subtitle">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium lorema doloremque laudantium, totam rem aperiam, eaque ipsa quae...</div>
                  <div class="cs-post_meta">
                    <div class="cs-post_avatar">
            ...
            <li>
              <div class="cs-post cs-style3">
                ...
                <div class="cs-post_right">
                  <h2 class="cs-post_title"><a href="#">Local SEO is a very essential role play for new websites</a></h2>
                  <div class="cs-post_subtitle">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium lorema doloremque laudantium, totam rem aperiam, eaque ipsa quae...</div>
                  <div class="cs-post_meta">
                    <div class="cs-post_avatar">
      ...
      <div class="cs-slider cs-style2 cs-gap-24">
        <div class="cs-slider_heading cs-style1">
          <div class="cs-section_heading cs-style1">
            ...
            <h2 class="cs-section_title" data-wow-duration="0.8s" data-wow-delay="0.2s">Team Q</h2>
          </div>
          <div class="cs-slider_arrows cs-style1 cs-primary_color">
            <div class="cs-left_arrow cs-center">
              <svg width="26" height="13" viewBox="0 0 26 13" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="3" data-lg-slides="4" data-add-slides="4">
          <div class="cs-slider_wrapper">
            <div class="cs-slide">
              <div class="cs-team cs-style1">
                <div class="cs-member_thumb">
                  <img class="filter" src="assets/img/Puvi.png" alt="Member">
                  <div class="cs-member_overlay"></div>
                </div>
                <div class="cs-member_info">
                  <h2 class="cs-member_name"><a href="team-details.html">Puvi Anban</a></h2>
                  <div class="cs-member_designation">Managing Director</div>
                </div>
            ...
            <div class="cs-slide">
              <div class="cs-team cs-style1">
                <div class="cs-member_thumb">
                  <img class="filter" src="assets/img/Ruban.png" alt="Member">
                  <div class="cs-member_overlay"></div>
                </div>
                <div class="cs-member_info">
                  <h2 class="cs-member_name"><a href="team-details.html">Ruban SM</a></h2>
                  <div class="cs-member_designation">Managing Director</div>
                </div>
                <div class="cs-member_social cs-primary_color">
                  <a href="#">
            ...
            <div class="cs-slide">
              <div class="cs-team cs-style1">
                <div class="cs-member_thumb">
                  <img class="filter" src="assets/img/Akshita.png" alt="Member">
                  <div class="cs-member_overlay"></div>
                </div>
                <div class="cs-member_info">
                  <h2 class="cs-member_name"><a href="team-details.html">Akshita Kancharla</a></h2>
                  <div class="cs-member_designation">Finance ManagerFinance</div>
                </div>
                <div class="cs-member_social cs-primary_color">
                  <a href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
            ...
            <div class="cs-slide">
              <div class="cs-team cs-style1">
                <div class="cs-member_thumb">
                  <img class="filter" src="assets/img/Chinmay.png" alt="Member">
                  <div class="cs-member_overlay"></div>
                </div>
                <div class="cs-member_info">
                  <h2 class="cs-member_name"><a href="team-details.html">Chinmay Sai</a></h2>
                  <div class="cs-member_designation">electrical and Embedded system designer</div>
                </div>
                <div class="cs-member_social cs-primary_color">
                  <a href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
  ...
  <div class="container" id="Recognition">
    <div class="container">
      <div class="cs-section_heading cs-style1 text-center">
        <h2 class="cs-section_title wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Our Recognition</h2>
      </div>
    </div>
    <div class="cs-height_70 cs-height_lg_45"></div>
    <div class="cs-partner_logo_wrap">
      <div class="cs-partner_logo"><img src="assets/img/Startup-india.png" alt="Partner"></div>
      <div class="cs-partner_logo"><img src="assets/img/MSME.png" alt="Partner"></div>
      <div class="cs-partner_logo"><img src="assets/img/STARTUPTN.png" alt="Partner"></div>
      <div class="cs-partner_logo"><img src="assets/img/MCA.png" alt="Partner"></div>
    </div>
  ...
  <section id="Careers">
    <div class="container">
      <div class="cs-cta cs-style1 cs-bg text-center cs-shape_wrap_1 cs-position_1" data-src="assets/img/cta_bg.jpeg" >
        ...
        <div class="cs-shape_1"></div>
        <div class="cs-cta_in">
          <h2 class="cs-cta_title cs-semi_bold cs-m0">Hiring Sucks !<br>but we <i>Still</i> want to :)</h2>
          <div class="cs-height_70 cs-height_lg_30"></div>
          <a href="https://www.linkedin.com/company/quazr-motros/jobs/" class="cs-text_btn wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
            <span>Apply now</span>
            <svg width="26" height="12" viewBox="0 0 26 12" fill="none" xmlns="http://www.w3.org/2000/svg">
