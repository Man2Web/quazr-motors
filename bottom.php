          ...
          <div class="col-lg-4 col-sm-6">
            <div class="cs-footer_item">
              <div class="cs-text_widget">
                <img style="transform: scale(1);"src="assets/img/footer_logo.png" alt="">
                <p>Redefining the Future</p>
              </div>
          ...
          <div class="col-lg-4 col-sm-6" id="Contact">
            <div class="cs-footer_item">
              ...
              <ul class="cs-menu_widget cs-mp0">
                <li>Chennai Institute Technology Business Incubation Forum, Chennai, Tamil Nadu 600069</li>
                <li>9176662788,9840247628</li>
                <li>info@quazrmotors.in</li>
              </ul>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6">
            <div class="cs-footer_item">
              ...
              <div class="cs-newsletter cs-style1">
                <formclass="cs-newsletter_form">
                  <input type="email" class="cs-form_field">
                </form>
    ...
    <div class="container">
      <div class="cs-bottom_footer">
        <div class="cs-bottom_footer_left">
          <div class="cs-copyright">Copyright © 2022 Quazr Motors India PVT LTD.</div>
        </div>
