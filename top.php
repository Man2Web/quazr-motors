...
<body>
        ...
        <div class="cs-main_header_in">
          <div class="cs-main_header_left">
            <a class="cs-site_branding" href="index.html">
              <img style="transform: scale(1.2);" src="assets/img/logo.png" alt="Logo">
            </a>
          </div>
          <div class="cs-main_header_center">
            <div class="cs-nav cs-primary_font cs-medium">
              <ul class="cs-nav_list">
                ...
                <li><a href="index.php#Recognition">Our Recognition</a>
                <li><a href="index.php#Careers">Careers</a>
  ...
  <div class="cs-side_header">
    ...
    <div class="cs-side_header_in">
      ...
      <a class="cs-site_branding" href="index.html">
        <img style="transform: scale(1.5);" src="assets/img/logo.png" alt="Logo">
      </a>
      <div class="cs-side_header_box">
        <h2 class="cs-side_header_heading">Redefining the Future</h2>
      </div>
      <div class="cs-side_header_box">
        ...
        <ul class="cs-contact_info cs-style1 cs-mp0">
          <li>
            ...
            <span>9176662788,9840247628</span>
          </li>
          <li>
